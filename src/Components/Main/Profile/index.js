...
const WorkExperience = ({name, url, position, specialization, date}, id) => {
  return (
    <li className={css.work} key={id}>
      <a className={css.name} href={url} target="_blank" rel="noopener noreferrer">{name}</a>
      <p className={css.position}>{position}</p>
      <p className={css.position}>{specialization}</p>
      <p className={css.specialization}>{date}</p>
    </li>
  )
}

const Education = ({name, url, degree, specialization, date}, id) => {
  return (
    <li className={css.knowledge} key={id}>
      <a className={css.name} href={url} target="_blank" rel="noopener noreferrer">{name}</a>
      <p className={css.degree}>{degree}</p>
      <p className={css.specialization}>{specialization}</p>
      <p className={css.date}>{date}</p>
    </li>
  )
}

const Certificate = (certificate, id) => {
  return (
